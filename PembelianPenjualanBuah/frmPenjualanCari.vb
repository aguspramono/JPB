Public Class frmPenjualanCari

    Private Sub frmPenjualanCari_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'cmbCari.
    End Sub


    Sub loadCari()
        Dim myQuery As String = "select p.NoTicket,p.Tgl2,p.Vehicle,p.NoAccount,p.DO,p.Keterangan,p.Product,p.Berat1Brutto,p.Berat2Tarra,p.ADJ,p.ADJNumber,p.Netto,p.Harga,p.BJR" & _
                                " from Penjualan p " & _
                                " where "
        ...
        Select Case intT
            Case 0
                myQuery = myQuery & "p.NoTicket"
            Case 1
                myQuery = myQuery & "p.Tgl2"
            Case 2
                myQuery = myQuery & "p.Vehicle"
            Case 3
                myQuery = myQuery & "p.NoAccount"
            Case 4
                myQuery = myQuery & "p.DO"
            Case 5
                myQuery = myQuery & "p.Keterangan"
            Case 6
                myQuery = myQuery & "p.Product"
        End Select
    ...
    Private Sub frmPenjualanCari_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
    ...
    Private Sub dgView_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If e.KeyCode = Keys.Enter Then
