...
Public Class LaporanRekapTbs
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PembelianPenjualanBuah.LaporanRekapTbs.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_kota() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedLaporanRekapTbs
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanRekapTbs = New LaporanRekapTbs()
        rpt.Site = Me.Site
        Return rpt
    End Function
