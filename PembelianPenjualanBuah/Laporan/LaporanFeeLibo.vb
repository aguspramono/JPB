...
Public Class LaporanFeeLibo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PembelianPenjualanBuah.LaporanFeeLibo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanFeeLibo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanFeeLibo = New LaporanFeeLibo()
        rpt.Site = Me.Site
        Return rpt
    End Function
